...
def handle_hello(p: MSIMRequest):
...
def handle_auth_plain(p: MSIMRequest):
	try:
...
def handle_register_plain(p: MSIMRequest):
...
def handle_register_instructions(p: MSIMRequest):
	return p.response(200, payload={
